...
const LocationRadiusBar = ({ location, radius, onRadiusChange, onDetectGPS, onPinCode }: LocationRadiusBarProps) => {
  ...
  return (
    <div className="bg-muted/40 border-b border-border">
      <div className="container mx-auto px-4 sm:px-6 py-1 flex items-center gap-2 sm:gap-3">
        {/* Location display + changer */}
        <Popover open={popOpen} onOpenChange={setPopOpen}>
          <PopoverTrigger asChild>
            <button className="flex items-center gap-1 text-[11px] hover:text-primary transition-colors min-w-0">
