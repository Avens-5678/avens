...
const DiscoverySection = ({ allItems, userLocation, discoveryBestRentals, discoveryBestInCity, discoveryBestCrew, discoveryTopVenues, featuredItems }: any) => {
  ...
  return (
    <div className="bg-[#FAFAFA] py-4 sm:py-6">
      ...
      {!isDiscoveryView && (
        <section className="py-4 sm:py-6 bg-muted/30">
          <div className="container mx-auto px-4 sm:px-6 lg:px-4">
            ...
            <div className="max-w-7xl mx-auto flex gap-5">
              <aside className="hidden lg:block w-56 flex-shrink-0">
                <div className="sticky top-20 bg-white rounded-2xl border border-gray-200 p-5 shadow-premium overflow-y-auto max-h-[calc(100vh-6rem)]">
                  <SidebarFilters />
                </div>
              </aside>
              ...
              <div className="flex-1 min-w-0">
                ...
                <div className="flex flex-wrap items-center justify-between gap-2 mb-4 bg-white rounded-xl border border-gray-200 px-4 py-2.5 shadow-sm">
