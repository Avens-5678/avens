...
('Baby Showers', 'baby_shower', 'Welcome your little one with a beautiful baby shower celebration. We create warm, joyful atmospheres perfect for celebrating new beginnings.', 'Delightful baby shower planning and decoration services'),
('Graduation Parties', 'graduation', 'Honor academic achievements with memorable graduation celebrations. From intimate family dinners to large graduation parties, we celebrate your success in style.', 'Graduation party planning and celebration coordination');
...
('Joyful Baby Showers', 'baby_shower', 'Welcome your little bundle of joy with a heartwarming baby shower celebration filled with love and excitement.', 'Our baby shower planning includes theme selection, invitation design, venue decoration, menu planning, game coordination, and gift management. We create a warm, celebratory atmosphere that honors the expecting parents and welcomes the new arrival.', '/placeholder.svg'),
('Graduation Celebrations', 'graduation', 'Celebrate academic achievements with memorable graduation parties that honor hard work and bright futures.', 'We coordinate every aspect of your graduation celebration, from venue selection and decoration to catering and entertainment. Our team ensures the celebration properly honors the graduate''s achievements while creating lasting memories for family and friends.', '/placeholder.svg');
