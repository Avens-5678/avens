...
import { Send, Sparkles, ArrowLeft, Loader2, Plus, Calendar, Package, Briefcase, TrendingUp, Search, Star, LayoutGrid } from "lucide-react";
...
const CLIENT_FEATURES = [
  { icon: Calendar, title: "Plan your dream event with AI-powered suggestions, budgets and timelines.", label: "Plan Events", color: "from-blue-500/10 to-indigo-500/10" },
  { icon: Package, title: "Browse premium rental equipment — stages, lighting, structures and more.", label: "Browse Rentals", color: "from-amber-500/10 to-orange-500/10" },
];
...
const VENDOR_FEATURES = [
  { icon: Package, title: "Find and rent equipment from the Evnting catalog for your projects.", label: "Rent Equipment", color: "from-emerald-500/10 to-teal-500/10" },
  { icon: LayoutGrid, title: "Manage your inventory, optimize listings, and grow your marketplace presence.", label: "Manage Business", color: "from-violet-500/10 to-purple-500/10" },
];
      ...
      <div className="flex flex-col h-full min-h-[70vh] max-h-[calc(100vh-120px)]">
            ...
            >
              ...
              <div className="flex items-center justify-between mb-8">
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-sm font-medium text-muted-foreground">Daily Evnting</span>
                </div>
              ...
              <div className="grid grid-cols-2 gap-3 mb-8">
                {features.map((feat, i) => (
                  <motion.div
                    ...
                    className={`rounded-2xl bg-gradient-to-br ${feat.color} border border-border/30 p-4 cursor-default`}
                  >
                    ...
                    <p className="text-xs text-foreground/80 leading-relaxed mb-2">{feat.title}</p>
        ...
        <div className="px-4 pb-4 pt-2">
          <div className="max-w-lg mx-auto">
            <div className="relative flex items-center rounded-2xl border border-border/50 bg-card shadow-soft">
              <div className="pl-4">
              ...
              <textarea
                ...
                rows={1}
                className="flex-1 resize-none bg-transparent px-3 py-3.5 text-sm focus:outline-none placeholder:text-muted-foreground/60"
              />
              <div className="pr-3">
                <button
      ...
      <div ref={scrollRef} className="flex-1 overflow-y-auto px-4 py-4 space-y-4">
              ...
              <div
                className={`max-w-[80%] sm:max-w-[70%] rounded-2xl px-4 py-3 text-sm leading-relaxed ${
                  msg.role === "user"
                    ...
                    : "bg-muted/40 text-foreground border border-border/30 rounded-bl-md shadow-soft"
                }`}
              >
                {msg.role === "assistant" ? (
        ...
        {isStreaming && messages[messages.length - 1]?.role !== "assistant" && (
          <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} className="flex justify-start">
            ...
            <div className="bg-muted/40 border border-border/30 rounded-2xl rounded-bl-md px-4 py-3 shadow-soft">
